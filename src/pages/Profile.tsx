...
const Profile: React.FC = () => {
 ...
 const mockProfile = {
      ...
      penalties: [
        { reason: 'Comportamento inadequado', duration: '30 dias' },
      ],
      list: lista
 };
  ...
  return (
    <div style={{ backgroundColor: '#EDEDED' }}>
        <AppBar position="static" sx={{ backgroundColor: '#26d07c', height: '65px', justifyContent: 'center' }}>
          <Toolbar>
              <IconButton onClick={() => navigate('/')} sx={{ color: 'white' }}>
                  <ArrowBackIcon />
              </IconButton>
              <img src="/logo-top-bar-bco.png" alt="Logo" style={{ width: '120px', height: '45px', marginLeft: '40px' }} />
          </Toolbar>
        </AppBar>
        <Stack
          direction="row"
      ...
      >
              {/* Chip dinâmico */}
              <Chip
                  label={(lista == 'Sem lista' || lista == '') ? 'O usuário não está numa lista' : `LISTA: ${lista}`}
              ...
              {(lista == 'Sem lista' || lista == '') ?
                  <IconButton onClick={handleOpenModal} sx={{ color: 'white', backgroundColor: '#ed6c02', "&:hover": { backgroundColor: "#f3862d" }, }}>
                      <AddIcon />
                  </IconButton>
                  : <Button
                      variant="contained"
          ...
          >
                  ...
                  <Grid container spacing={2}>
                      ...
                      <Grid item xs={6}>
                          <TextField
                              ...
                              onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleChange('gender', e.target.value)}
                              fullWidth
                              error={!gender}
                      ...
                      <Grid item xs={6}>
                          <TextField
                              ...
                              onChange={(e: React.ChangeEvent<HTMLInputElement>) => handleChange('profile', e.target.value)}
                              fullWidth
                              margin="normal"
                          >
              ...
              >
                  ...
                  <TextareaAutosize
                      ...
                      value={newIncident}
                      onChange={(e: React.ChangeEvent<HTMLInputElement>) => setNewIncident(e.target.value)}
